...
const FeaturedGuides = () => {
  return (
    <section id="guides" className="py-16" data-testid="guides-section">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-12 animate-fade-in">
          <div>
            ...
            <p className="text-lg text-muted-foreground" data-testid="guides-description">
              Learn from experts and master AI-powered creative techniques
            </p>
          </div>
          <a 
            href="#all-guides" 
