        ...
        <div className="overflow-x-auto scrollbar-hide">
          <div className="flex gap-3 pb-4 animate-slide-in" style={{ width: 'max-content' }}>
            {tools.map((tool) => (
              <div 
                key={tool.id}
                className="group relative cursor-pointer flex-shrink-0 w-[90px] h-[100px] sm:w-[154px] sm:h-[110px] lg:w-[240px] lg:h-[120px] xl:w-[240px] xl:h-[130px]"
              ...
              >
                ...
                >
                  ...
                  <div 
                    className="w-8 h-8 sm:w-12 sm:h-12 lg:w-16 lg:h-16 xl:w-[72px] xl:h-[72px] rounded-full flex items-center justify-center mb-1 sm:mb-2 lg:mb-3 transition-all duration-300"
                    style={{ 
                      backgroundColor: 'hsla(253, 100%, 72%, 0.1)'
                    }}
                  >
                    <div className="scale-50 sm:scale-75 lg:scale-90 xl:scale-100" style={{ color: 'hsl(253, 100%, 72%)' }}>
                      {tool.icon}
                    </div>
                  </div>
                  <h3 
                    className="font-bold transition-colors text-[8px] sm:text-[10px] lg:text-xs xl:text-sm text-center leading-tight px-1 sm:px-2 lg:px-3" 
